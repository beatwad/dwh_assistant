...
def test_retrieve_most_relevant_answer(llm_instance, score, metadata, expected):
    """Test retrieving of the most relevant answer."""
...
def test_generate_prompt(_, llm_instance):
...
def test_natural_language_to_sql_model_success(llm_instance):
    ...
    mock_retrieved_answer = {"answer": None, "error": "", "node_id": "123"}
